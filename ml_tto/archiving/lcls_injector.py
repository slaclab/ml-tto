...
import numpy as np
def isotime():
    return datetime.datetime.now().replace(tzinfo=datetime.timezone.utc).astimezone().replace(microsecond=0).isoformat()
isotime()
...
def numpy_save(path = run_dir + 'Data/', spec = "otr2"):
    ...
    pvname_list = ["SOLN:IN20:121:BACT",
    "QUAD:IN20:121:BACT",
    "QUAD:IN20:122:BACT", 
    "QUAD:IN20:361:BACT", 
    "QUAD:IN20:371:BACT",
    ...
    img_list_otr2 = ["OTRS:IN20:571:Image:ArrayData",
    "OTRS:IN20:571:XRMS",
    "OTRS:IN20:571:YRMS",
    ...
    img_list_otr3 =["OTRS:IN20:621:IMAGE",
    "OTRS:IN20:621:XRMS",
    "OTRS:IN20:621:YRMS",
    ...
    img_list_vcc =['CAMR:IN20:186:IMAGE',
